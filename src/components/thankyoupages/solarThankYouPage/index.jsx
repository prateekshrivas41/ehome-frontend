...
export default function ThankYouPage() {
  ...
  return (
    <div>
      <MainFormView>
        <div className="sub-thank-you-text">Thanks for your patience!</div>
        <div className="describe-thank-you-text">
          A contractor consultant, who aligns with your needs,
          <br /> will be calling you within the next few minutes to discuss your
          quote in detail.
        </div>
        <Lottie
